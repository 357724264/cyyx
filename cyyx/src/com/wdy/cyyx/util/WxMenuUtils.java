...
import com.wdy.cyyx.common.Article;
import com.wdy.cyyx.common.KfArticle;
import com.wdy.cyyx.common.Snsapi;
...
public class WxMenuUtils {
	 ...
	 */
	public static String uploadArticles(List<Article> articles,
		...
		HttpPost httpost = HttpClientConnectionManager
				.getPostMethod("https://api.weixin.qq.com/cgi-bin/media/uploadnews?access_token="
						+ accessToken);
		...
		// JSONObject object = JSON.parseObject(jsonStr);
		return retobject.getString("media_id");
	}
	 ...
	 * @throws ClientProtocolException
	 */
	public static String sendArticles(String accessToken,
			List<KfArticle> articles, String openid)
	 ...
	 * @throws ClientProtocolException
	 */
	public static WxUser getUserInfobyWeb(String access_token, String openid)
			throws ClientProtocolException, IOException {
	 ...
	 * @throws IOException
	 */
	public static String thbuyNotify(String accessToken, String weixinid,
			String templateid, String productname, double money, String number)
			throws ClientProtocolException, IOException {
		if (accessToken == null) {
			return null;
		}
		...
		StringEntity s = new StringEntity(
				"{\"touser\":\""
						...
						+ "\",\"template_id\":\""
						+ templateid
						+ "\",\"url\":\"#\",\"topcolor\":\"#FF0000\",\"data\":{\"first\": {\"value\":\"提货号码为"
						+ number
						+ "\",\"color\":\"#173177\"},\"keyword1\":{\"value\":\""
						+ money
						+ "\",\"color\":\"#173177\"},\"keyword2\":{\"value\":\"无限期\",\"color\":\"#173177\"},\"remark\":{\"value\":\"可以到任意代理点领取商品\",\"color\":\"#173177\"}}}",
				"UTF-8");
		s.setContentEncoding("UTF-8");
		s.setContentType("application/json");
		post.setEntity(s);
	 ...
	 * @throws IOException
	 */
	public static String thuseNotify(String accessToken, String weixinid,
			String templateid, String productname, String number)
			throws ClientProtocolException, IOException {
		if (accessToken == null) {
			return null;
		}
		...
		StringEntity s = new StringEntity(
				"{\"touser\":\""
						...
						+ "\",\"template_id\":\""
						+ templateid
						+ "\",\"url\":\"#\",\"topcolor\":\"#FF0000\",\"data\":{\"first\": {\"value\":\"您好，您的一张提货号已经使用"
						+ "\",\"color\":\"#173177\"},\"keyword1\":{\"value\":\""
						+ number
						+ "\",\"color\":\"#173177\"},\"keyword2\":{\"value\":\"无\",\"color\":\"#173177\"},\"keyword3\":{\"value\":\"无限期\",\"color\":\"#173177\"},\"remark\":{\"value\":\"商品名："
						+ productname + "\",\"color\":\"#173177\"}}}", "UTF-8");
		s.setContentEncoding("UTF-8");
		s.setContentType("application/json");
		post.setEntity(s);
		post.getParams().setParameter(HttpMethodParams.HTTP_CONTENT_CHARSET,
	 ...
	 * @throws ClientProtocolException
	 */
	public static Snsapi getOpenidByCode(String appid, String appsecret,
		...
		HttpResponse response = httpclient.execute(get);
		String jsonStr = EntityUtils.toString(response.getEntity(), "utf-8");
		System.err.println("=========22222222=====" + jsonStr);
		JSONObject object = JSONObject.fromObject(jsonStr);
		if (object == null) {
			return null;
		}
		return new Snsapi(object);
	}

	public static void main(String[] args) throws Exception {
		String accessToken = "bA5lKVeRDsQoCv6ldvXO9dbKH8xkw15lbmKuOIXydF7ogWjKF-kxCT4dsZUAwj14WO0mVh7ElZhNE8J160ADApe1Sf-1e0Fc_eBG_uORH7E";
		WxMenuUtils
				.sendText(accessToken, "你好啊", "o3V_Tsgnu033EYHCu-8x_XK683yw");
	}
}