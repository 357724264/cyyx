   	...
   	<script type="text/javascript">
   		$(document).ready(function(){
			...
			$(".common-btn").bind("click",function(){
				...
				$.ajax({
					url:"json/mygrounp!create.action",
					data:{lm:lm,pid:${pid},sm:sm},
					type:"post",
...
<body class="head_body">
    ...
    <div class='container-fluid'>
        <div class="row">
            ...
            <div class="btn-group" >
                <button class="common-btn">我要组团<#if product.zgmoney??&&(product.zgmoney gt 0)>[需支付${product.zgmoney}]</#if></button>
            </div>
        </div>
    </div>
