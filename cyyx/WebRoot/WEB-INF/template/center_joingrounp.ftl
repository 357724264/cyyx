...
<body class="head_body_1">
    <div class="header">
        <div class="header-inner">
            ...
            <div class='header-title'>我的参团</div>
    ...
    <div class='container-fluid'>
        <div class="row" id="row">
            ...
            <div class="order-tab">
                <ul class='tab-box tab-box-2'>
                    <li class="tab-list <#if tt==0>tab-checked</#if>">
                        <a href="center!joingrounp.action?tt=0">进行中</a>
                    </li>
                    <li class="tab-list <#if tt==-1>tab-checked</#if>">
                        <a href="center!joingrounp.action?tt=-1">已结束</a>
                    </li>
				</li>
            </ul>
