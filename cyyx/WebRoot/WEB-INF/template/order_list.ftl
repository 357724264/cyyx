...
<body class="head_body_1">
    ...
    <div class='container-fluid'>
        <div class="row" id="row">
            <div class="order-tab">
                <ul class='tab-box'>
                    <li class="tab-list <#if tt=="paid">tab-checked</#if>">
                        <a href="order!list.action?tt=paid">待发货</a>
                    </li>
                    <li class="tab-list <#if tt=="send">tab-checked</#if>">
                        <a href="order!list.action?tt=send">已发货</a>
                    </li>
                    <li class="tab-list <#if tt=="deal">tab-checked</#if>">
                        <a href="order!list.action?tt=deal">已收货</a>
                    </li>
                </ul>                
            </div>
