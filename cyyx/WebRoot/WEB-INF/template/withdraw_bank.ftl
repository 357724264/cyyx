...
<head>
  ...
  <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="${base}/home/js/jquery-1.8.2.min.js"></script>
    <script type="text/javascript" src="${base}/home/js/luhmCheck.js"></script>
          ...
          if(luhmCheck(card)==false){
            return false;
   				...
   				$.ajax({
   					...
   					data:{name:name,cardnum:card,bank:bank,phone:phone,money:money,tt:1},
   					type:"post",
        ...
        <div class="row">
            <div class='common-group'>
                ...
                <div class="tixian-way">
                   <div class="way-group xian">
                       <a href="withdraw!wx.action">
                           <i>&#xe61a;</i>
                           <span>兑换到微信</span>
                       </a>
                   </div>
                   <div class="way-group waychecked">
                       <a href="javascript:;">
                           <i>&#xe615;</i>
                           <span>兑换到银行卡</span>
                       </a>
            ...
            <div class="common-form-group common-margin">
                ...
                <div class="common-form-list">
                    <label>手机号</label>
                    <div class="text-box">
                        <input type="text" class="common-input" id="phone" placeholder="请填写正确手机号" />
                    </div>
                </div>
                <div class="common-form-list">
                    <label>开户行所在地</label>
                    <div class="text-box">
                        <input type="text" class="common-input" id="bank" placeholder="请填写银行以及开户支行" />
                    </div>
                </div>
                <div class="common-form-list">
                    <label>银行卡号</label>
                    <div class="text-box">
                        <input type="number" class="common-input" id="card" placeholder="请填写银行卡号" />
                    </div>
                </div>
                <div class="common-form-list">
                    <label>兑换金额</label>
                    <div class="text-box">
                        <input type="number" class="common-input" id="money" onkeyup="clearNoNum(this)" placeholder="您要兑换的金额" />
                    </div>
                </div>
            </div>
            <div class="btn-group">
