  ...
  <div class="page-header position-relative">
      <h1> <a href="product!list.action"><i class="icon-laptop" style="font-size:20px"></i>活动管理</a> <small> <i class="icon-double-angle-right"></i> 编辑活动 </small> </h1>
	    <div class="ace-settings-container" id="ace-settings-container"  style=" margin-right:15px; margin-top:-45px; ">
              <div class="btn-group">
                <button class="btn btn-success btn-block" onClick="location.href='product!list.action'"><i class="icon-cloud-upload"></i>返回上一页</button>
              </div>
            </div>
    </div>
          ...
          <div id="home" class="tab-pane in active">
            ...
            <div class="row-fluid">
             ...
             <#assign isEdit=false>
              ...
              <div class="span12" style="margin-top:30px;">
                <form class="form-horizontal" class="mindform" type="post" action="<#if isEdit>json/product!update.action<#else>json/product!save.action</#if>" />
            <style>
            .control-label{height:40px;line-height:25px;font-size:16px;}
               ...
               <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" id="pvideo" name="pvideo" placeholder="若无视频可不填写" value="${(product.pvideo)!}" class="span8" style="height:40px;line-height:30px;font-size:16px;width:500px;"/>
                  </div>
                </div>
               ...
               <div class="control-group">
                	...
                	<div class="controls" style="line-height:40px;">
               			<img class="editable" alt="Alex's Avatar" id="file99-filepreview" src="<#if product??&&product.pic??>${product.pic}<#else>${base}/assets/img/cqpic.jpg</#if>"  style="width:229px;height:147px; " />
                		...
                		<input id="file99-pic" type="hidden"  name="pic" value="${(product.pic)!}"/>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="orderById" id="orderById" placeholder="数字越大越靠前" value="${(product.orderById)!}" class="span4 validate[required]" style="height:40px;line-height:30px;font-size:16px;"/>
                  </div>
                </div>
                ...
                <div class="control-group"  style="padding-bottom:10px;">
                    ...
                    <div class="controls"   style="font-size:14px;">
                    	<#if product??&&product.ggs??>
                    		<#list product.ggs as ggg>
                    	...
                    	<input type="hidden" value="${(product.gg)!}" name="gg" id="gg" />
					</div>
				</div>
				...
				<div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="rawmoney" id="rawmoney" placeholder="" value="${(product.rawmoney)!}" class="span4 validate[required]" style="height:40px;line-height:30px;font-size:16px;"/>
                 	元
                  </div>
                </div>
                 ...
                 <div class="control-group">
                  <label class="control-label" for="zlm">组团资格：</label>
                  <div class="controls">
                    <input type="text" name="zgmoney" id="zgmoney" placeholder="" value="${(product.zgmoney)!}" class="span4 validate[required]" style="height:40px;line-height:30px;font-size:16px;"/>
                  	元
                  </div>
                </div>
                
                <div class="control-group">
                  <label class="control-label" for="zlm">组团失败价格：</label>
                  <div class="controls">
                    <input type="text" name="sbmoney" id="sbmoney" placeholder="" value="${(product.sbmoney)!}" class="span4 validate[required]" style="height:40px;line-height:30px;font-size:16px;"/>
                  	元
                  </div>
                </div>
                
                 <div class="control-group">
                  <label class="control-label" for="zlt">组团助力时限：</label>
                  <div class="controls">
                    <input type="text" name="zltime" id="zltime" placeholder="" value="${(product.zltime)!}" class="span4 validate[required]" style="height:40px;line-height:30px;font-size:16px;"/>
                  	天
                  </div>
                </div>
                
                <div class="control-group">
                  <label class="control-label" for="zlt">需要助力人数：</label>
                  <div class="controls">
                    <input type="minnum" name="minnum" id="zltime" placeholder="" value="${(product.minnum)!}" class="span4 validate[required]" style="height:40px;line-height:30px;font-size:16px;"/>
                  	人
                  </div>
                </div>
                 ...
                 <div class="control-group">
                  ...
                  <div class="controls">
                  	<#if product??&&product.endtime??>
                 		<input type="text" class="mh_date span6" name="endtime" id="endtime" readonly="true" value="${product.endtime?number_to_datetime?string("yyyy-MM-dd HH:mm")}" style="height:40px;line-height:30px;font-size:16px;" />
                  	<#else>
                  		<input type="text" class="mh_date span6" name="endtime" id="endtime" readonly="true" value="${(product.endtime)!}" style="height:40px;line-height:30px;font-size:16px;" />
                  	 </#if>
                  </div>
                </div>
                ...
                <div class="control-group">
                  <label class="control-label" for="title">团购价格：</label>
                  <div class="controls">
                    <input type="text" name="tgmoney" id="tgmoney" placeholder="" value="${(product.tgmoney)!}" class="span4 validate[required]" style="height:40px;line-height:30px;font-size:16px;"/>
                  	元
                  </div>
                </div>
