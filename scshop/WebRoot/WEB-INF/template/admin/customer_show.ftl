				...
				<table cellspacing="0" cellpadding="0" width="100%" class="zxtable">
					...
					<tr  class="tt-0">
						<td class="zxltd"><span class="must">*</span>代理等级：</td>
							...
							<#if alist??&&customer.agentid??>
								<#list alist as agent>
									<#if customer.agentid==agent.id>
									<td><input class="dia_inp" type="text" placeholder=" " value="${agent.name} "  readonly="readonly"></td>
									</#if>
								</#list>
							<#else>
								<td><input class="dia_inp" type="text" placeholder=" " value="非代理 "  readonly="readonly"></td>
							</#if>
