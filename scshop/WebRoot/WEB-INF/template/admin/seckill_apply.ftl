	 ...
	 <form id="myform" name="myform" method="post" action="seckill!save.action">
			...
			<div class="zxform">
				...
				<tr>
					...
					<td><input class="dia_inp time" id="beginTime" type="text" name="beginTime"></td>
				</tr>
				<tr class="hidden_ele">
					<td class="zxltd">结束时间：</td>
					<td><input class="dia_inp time" id="endTime" type="text" name="endTime"></td>
				</tr>
				<tr class="hidden_ele">
					<td class="zxltd">限购数量：</td>
					<td><input class="dia_inp time" id="num" type="text" name="num"></td>
				</tr>
