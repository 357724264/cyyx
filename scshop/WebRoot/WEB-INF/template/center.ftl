...
<body>
	  	...
	  	<div class="content padd-content">
			...
			<div class="grzx-listgroup">
					<a class="external" href="bankcard!list.action">
						<i class='iconfont icon-jifen grzxlbicon'></i>&nbsp;我的银行卡
	...
	<div class="page" id='router3'>
	  	...
	  	<div class="content padd-content">
	  		...
	  		<div class="defaultbtnbox">
	  			<button type="button" class="dia_btn dialog_ok defaultbtn"  <#if agentBill??>style="background:#A9A9A9" disabled="disabled"</#if> >提交申请</button>
