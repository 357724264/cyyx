...
public class CustomerAction extends BaseAction {
   ...
   public String list(){
		...
		list = customerService.getLikeList("phone", keyword, null, params, (pn-1)*Const.BACK_PAGE_SIZE, Const.BACK_PAGE_SIZE,  "createDate", "desc", false);
   ...
   public String totalNum() {
		...
		tn = customerService.getLikeTotalCount("phone", keyword, null, null, false);
	...
	public String alterpass(){
		...
		Admin admin1 = adminService.get(new QueryParam(2).add("id", adminId)
				.add("password", md5PasswordEncoder.encodePassword(password_now, null)), false);
		if(admin1==null){
			return ajaxJson("{'error':1}");
		}
		
		Admin admin = adminService.get(new QueryParam(1).add("id", adminId), false);
